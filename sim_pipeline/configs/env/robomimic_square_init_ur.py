...
# This is identical to the ID (w.r.t. robomimic expert square nut) location for the original RobosuiteSquareEnv
# UR = Upper Right
@dataclass
class URRobomimicSquareEnvConfig(RobomimicSquareEnvConfig):
