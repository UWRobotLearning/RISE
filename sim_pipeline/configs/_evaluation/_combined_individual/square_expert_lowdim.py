...
from sim_pipeline.configs.exp._eval._combined_individual.square_expert_diffusion_lowdim import DiffusionEvalExpConfig
...
class RobomimicEvalConfig(EvaluationConfig):
    name: str ='diffusion_square_expert_lowdim'
